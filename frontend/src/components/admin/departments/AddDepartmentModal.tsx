...
import { XIcon, PlusCircleIcon, AcademicCapIcon } from '@heroicons/react/outline';
                ...
                <form onSubmit={handleSubmit} className="mt-4 space-y-5">
                  <div>
                    ...
                    <input
                      type="text"
                      required
                      className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
